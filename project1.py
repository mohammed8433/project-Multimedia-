...
play_button = tk.Button(button_frame, text="Play", command=play, font=("Arial", 12), width=10)
...
save_button = tk.Button(button_frame, text="Set", command=set1, font=("Arial", 12), width=10)
